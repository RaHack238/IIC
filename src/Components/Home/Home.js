				...
				<div id='otherthanLogo'>
					...
					<div className='motivesWrapper'>
						<div className='motives1 motives'>
							<h4>Ideate</h4>
							<h5>
								Create thought ideation and an environment to identify social problems
							</h5>
						</div>
					...
					<h6 className='text'>
						IIC, IIT Goa aims to develop a culture of innovation by providing relevant
						education and solving real world problems and developing all faculty,
						students and all staff and support systems into future leaders and
						entrepreneurs. To develop a culture of “innovation-to-market” and empower
						all stakeholders to lead the entrepreneurial way.
					</h6>
				</div>
			</div>
		);
