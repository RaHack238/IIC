...
export default class ContactUsFooter extends Component {
	constructor(props) {
		...
		console.log(this.state.footer_open);
	}
	...
	componentDidMount() {
		...
		setTimeout(() => this.setState({ footer_open: this.props.footer }), 1);
	}
	...
	render() {
		return (
			<div className={'contact__us__footer ' + (this.state.footer_open ? 'footer__open' : 'footer__closed')}>
				<div className='footer__arrow__div' onClick={this.toggle_footer}>
					<img src={this.state.footer_open ? down_arrow : up_arrow} className='arrow__img' />
				</div>
				{this.state.windowWidth > 578 ? (
					<div className='row contact__us_info__div'>
						<div className='footer__left col-sm-6 col-xs-12'>
							<div className='icons__div'>
								<a href='https://twitter.com/iiciitgoa'>
									<img src={twitter_icon} className='footer__icon' alt='twitter' />
								</a>
							...
							<p className='left__column__text'>
								<p className='contact__us__mobile__text'>
									<a className='contact__us__mobile__text_1' href='https://mic.gov.in/'>
										MIC
									</a>
								</p>
								<p className='contact__us__mobile__text'>
								...
								<p className='contact__us__mobile__text'>
									<a className='contact__us__mobile__text_1' href='https://www.aicte-india.org/'>
										AICTE
									</a>
								</p>
							</p>
						...
						<div className='footer__right col-sm-6 col-xs-12'>
							<p className='right__column__text'>Indian Institute of Technology</p>
					...
					<div className='footer__info__div__mobile'>
						<div className='icons__div_mobile'>
							<a href='https://twitter.com/iiciitgoa'>
								<img src={twitter_icon} className='footer__icon_mobile' alt='twitter' />
							</a>
							<a href='mailto:iic@iitgoa.ac.in'>
								<img src={email_icon} className='footer__icon_mobile' alt='email' />
							</a>
						</div>
						<p className='contact__us__mobile__text'>
							<a className='contact__us__mobile__text_1' href='https://mic.gov.in/'>
						...
						<div className='iit__goa__text'>
							<p className='right__column__text__mobile'>Indian Institute of Technology Goa</p>
