...
function Programs() {
    ...
    const Card1Block = () => {
        return (
            <div className="card_1_block"  >
                <div className="idea_funnel card_block" style={{ backgroundColor: 'var(--light-blue)'}}>
    
                    <img src ={ideaFunnel} alt="Idea Funnel"  onClick=  {handleIdeaFunnel} width ='70%' height = '70%' id="card_img" />                                    
                                                
                    <p style={{color:'var(--dark-blue)'}} id="info_card_title">Idea Funnel</p>    
            ...
            <div className="card_1_shown"  >
                <div className="idea_funnel" style={{ backgroundColor: 'var(--light-blue)'}}>
                    ...
                    <div className="info_card_content" >
                        <p style={{color:'var(--dark-blue)'}} id="info_card_content_text_1" >Idea Funnel is a continuous tool for idea scouting, validation and facilitation. In order to encourage students to bring forward executable ideas, IIC has set up an online idea consolidation mechanism, details of which are attached.</p>
                        <p style={{color:'var(--dark-blue)',}} id="info_card_content_text_1">Please read the attached IDEA Funnel for details.(Appendix A1).</p>
                        <p style={{color:'var(--dark-blue)'}} id="info_card_content_text_1"> Link for the application is: <a href="https://forms.gle/BeZuxVrnXFQXd9nB9" target="_blank">https://forms.gle/BeZuxVrnXFQXd9nB9</a> ( All question details in the appendix)</p>
    ...
    const Card1 = () => {
        return (            
            isIdeaFunnelShown ? <Card1Shown /> : <Card1Block />
        );
    }
        ...
        return (
            <div className="card_2_block"  >
                <div className="ignite" style={{ backgroundColor: 'var(--dark-blue)'}} >
                    ...
                    <img src ={igniteIcon} alt="Ignite"  onClick=  {handleIgnite} width ='70%' height = '70%' id="card_img" />                                    
        ...
        return (
            <div className="card_2_shown"  >
                <div className="ignite" style={{ backgroundColor: 'var(--dark-blue)'}} >
                    ...
                    <div className="info_card_content" >
                        <p style={{color:'var(--orange)'}} id="info_card_content_text_2" >POC Grant was developed to enable entrepreneurial spirit and develop a culture of innovation. Interested students work on their idea proposal with faculty and teams to develop a prototype.</p>
                        <p style={{color:'var(--orange)',}} id="info_card_content_text_2">please read the attached IGNITE document. (Appendix A2).</p>
                    </div>
                </div>
            </div>
        );
    ...
    const Card2 = () => {
        return (            
            isIgniteShown ? <Card2Shown /> : <Card2Block />
        );
    }
        ...
        return (
            <div className="card_3_block"  >
                <div className="aeIEP"style={{ backgroundColor: 'var(--light-blue)'}} >
                    ...
                    <img src ={aeiEPicon} alt="aeIEP"  onClick=  {handleAeiEP} width ='70%' height = '70%' id="card_img" />                                    
                                                
                    <p style={{color:'var(--dark-blue)'}} id="info_card_title">AeIEP</p>    
    ...
    const Card3 = () => {
        return (            
            isAeiEPShown ? <Card3Shown /> : <Card3Block />
        );
    }
    ...
    const Card4 = () => {
        return (            
            isStartupLabShown ? <Card4Shown /> : <Card4Block />
        );
    }
    return (
        <div className="Program" >
            ...
            <div className="content_2" >
                    <div className="accessible" >
                        <p style={{color:'var(--dark-blue)',}} id="heading_text">Accessible</p>
                        <p style={{ color: 'var(--orange)',}} id="content_text">All graduate and undergraduate students can participate</p>
                    </div>
                    <div className="educational" >
                        <p style={{color:'var(--orange)',}} id="heading_text">Educational</p>
                        <p style={{ color: 'var(--dark-blue)', }}  id="content_text">Designed to fit within the academic experience, the programs help students pursue entrepreneurial ideas along with classwork</p>
                    </div>
                    <div className="personalized" >
                        <p style={{color:'var(--darl-blue)',}} id="heading_text">Personalized</p>
                        <p style={{ color: 'var(--orange)',}} id="content_text">Student teams are matched with mentors and given personalized attention that best support them in moving their ideas forward</p>
                    </div>
                    <div className="practical" >
                        <p style={{color:'var(--orange)', }} id="heading_text">Practical</p>
                        <p style={{ color: 'var(--dark-blue)', }} id="content_text"> Students learn by doing and gain real world experience in moving their ideas forward from concept to creation</p>
                    </div>
            </div>
            ...
            {mobile && 
                    <div className="mobile-card-content" style={{display: 'flex', flexGrow: '1', justifyContent: 'center',border: 'none', bottom: '0px', width: '100vw',}}>
                        <Carousel onSelect={handleActiveIndex} activeIndex={activeIndex}  interval={null} controls={true} indicators={false} wrap={false} nextIcon={ <img  src={(activeIndex == 0 || activeIndex == 2 )? nextBlue : nextOrange} /> } prevIcon = {<img src={(activeIndex == 1 || activeIndex == 3) ? prevOrange : prevBlue} />}  prevLabel={''} nextLabel={""}>
                            <Carousel.Item >
                                <Card1 />
                            </Carousel.Item>
